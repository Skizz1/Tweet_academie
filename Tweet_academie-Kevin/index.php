					...
					<form id="formRegister">
						...
						<div class="form-group1">
							<div class="input-group">
								...
								<span id="" class="input-group-addon info"><span id="" class="glyphicon glyphicon-calendar"></span></span>
							</div>
						</div>
						<div class="form-group">
							<div class="input-group">
						...
						<div class="form-group">
							<div class="input-group">
								...
								<span id="imgCity" class="input-group-addon info"><span id="cityRegister" class="glyphicon glyphicon-home"></span></span>
							</div>
						</div>
						<div class="form-group1">
							<div class="input-group">
